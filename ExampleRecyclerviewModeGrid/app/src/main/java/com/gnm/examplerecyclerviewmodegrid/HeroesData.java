...
class HeroesData {
    ...
    static ArrayList<com.gnm.examplerecyclerviewmodegrid.Hero> getListData() {
        ArrayList<com.gnm.examplerecyclerviewmodegrid.Hero> list = new ArrayList<>();
        for (int position = 0; position < heroNames.length; position++) {
            com.gnm.examplerecyclerviewmodegrid.Hero hero = new com.gnm.examplerecyclerviewmodegrid.Hero();
